...
//Main-pages
import ImagingCenters from "../pages/ImagingCenters";
...
import RegistrationInformation from "../pages/Authentication/RegistrationInformation";
...
const authProtectedRoutes = [
  ...
  { path: "/imaging-centers", component: <ImagingCenters /> },
  { path: "/radiologists", component: <Radiologists /> },
  { path: "/completed-cases", component: <CompletedCases /> },
  {
...
const publicRoutes = [
  ...
  { path: "/registration-information", component: <RegistrationInformation /> },
